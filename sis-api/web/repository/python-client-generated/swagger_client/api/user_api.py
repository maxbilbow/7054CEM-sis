...
class UserApi(object):
    ...
    def find_by_email(self, email, **kwargs):  # noqa: E501
        """Get a user id by email  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.find_by_email(email, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str email: The email of the user to retrieve (required)
        :return: str
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.find_by_email_with_http_info(email, **kwargs)  # noqa: E501
        else:
            (data) = self.find_by_email_with_http_info(email, **kwargs)  # noqa: E501
            return data

    def find_by_email_with_http_info(self, email, **kwargs):  # noqa: E501
        """Get a user id by email  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.find_by_email_with_http_info(email, async_req=True)
        >>> result = thread.get()
        ...
        if ('email' not in params or
            ...
            raise ValueError("Missing the required parameter `email` when calling `find_by_email`")  # noqa: E501
    ...
    def remove_user(self, user_id, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.remove_user_with_http_info(user_id, **kwargs)  # noqa: E501
        else:
            (data) = self.remove_user_with_http_info(user_id, **kwargs)  # noqa: E501
            return data

    def remove_user_with_http_info(self, user_id, **kwargs):  # noqa: E501
        """Remove a user  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.remove_user_with_http_info(user_id, async_req=True)
        >>> result = thread.get()
