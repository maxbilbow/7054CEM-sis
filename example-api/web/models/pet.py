...
class Pet(Model):
    ...
    """
    def __init__(self, id: int=None, name: str=None, breed: str=None, price: float=None):  # noqa: E501
    ...
    def breed(self, breed: str):
        ...
        """
        if breed is None:
            raise ValueError("Invalid value for `breed`, must not be `None`")  # noqa: E501
